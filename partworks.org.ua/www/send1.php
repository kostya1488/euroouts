...
$adres = $_POST['adres'];
$name_vak = $_POST['name_vak'];
$info_vak = $_POST['info_vak'];
$treb = $_POST['treb'];
$phone = $_POST['phone'];
$email = $_POST['email'];
$to = 'mail@partworks.org.ua'; 
$subject = 'Резюме 	Соискателя';    
$body ="Название компании и основное направление её деятельности: $company\n Контактные данные компании (адрес, телефон, факс, электронная почта, Ф.И.О. контактного лица): $adres\n Название вакансии: $info_vak\n Требования к соискателю (пол, возраст, прописка, гражданство, образование, опыт работы, квалификация, владение ПК и иностранными языками, наличие водительских прав и автомобиля): $treb\n ";
...
<div id="content">
    <div class="nav">
		...
		<div class="partner">
			<div class="one-col">
				<div class="header">
	<h1>Спасибо. Вашa заявка отправленна.</h1>
